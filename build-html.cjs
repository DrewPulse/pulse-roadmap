...
const SECTIONS = [
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Bring Your Own Tools", status: "planned",
        summary: "Bring your own capture, analysis, and reporting tools — or just upload data directly.",
        description: "Agencies and in-house teams have invested years in their own tooling and processes. Rather than asking them to switch, Pulse connects to the tools they already use across the whole research workflow: capture tools like survey, usability, and diary study platforms; analysis, transcription, and reporting tools; and BI dashboards. Teams that just want to bring results in can upload data directly. Use Pulse for the parts that help and keep the rest of your stack intact." },
    ],
  },
  {
    ...
    features: [
      ...
      { name: "Cross-Capture Analysis", status: "planned",
      ...
      { name: "Integrated Reporting", status: "planned",
